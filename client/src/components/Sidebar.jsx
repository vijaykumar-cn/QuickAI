...
const navItems = [
  ...
  { to: '/ai/remove-object', label: 'Review Object', Icon: Scissors },
...
const Sidebar = ({ sidebar, setSidebar }) => {
  ...
  return (
    <div className={`w-60 bg-white border-r border-gray-200 flex
      ...
      bottom-0 ${sidebar ? 'max-sm:translate-x-0' : 'max-sm:-translate-x-full'} transition-all duration-300
      ease-in-out`}>
      ...
      <div className='w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between'>
          <div  onClick={openUserProfile}className='flex gap-2 items cursor-pointer'>
